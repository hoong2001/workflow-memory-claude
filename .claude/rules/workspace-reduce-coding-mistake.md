# workspace-reduce-coding-mistake.md
...
- **DRY** — extract shared logic on the second occurrence, never on the first. An abstraction
  built for one caller usually fits the second one badly.
