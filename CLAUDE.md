...
- Credential hygiene (hook + `/wp-secret-scan`) → `.claude/rules/workspace-no-secrets.md`; the hook itself is `.claude/hooks/block-secrets.mjs`, wired in `.claude/settings.json`
